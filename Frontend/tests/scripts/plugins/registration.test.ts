...
describe('injectPluginModule / clearPluginScripts', () => {
  ...
  it('injects a script element into head with plugin context', async () => {
    const { injectPluginModule } = await import('@scripts/plugins/registration');
  ...
  it('clears injected scripts', async () => {
    const { injectPluginModule, clearPluginScripts } = await import('@scripts/plugins/registration');
...
describe('clearPluginUi / trackUiNode', () => {
  ...
  it('removes tracked UI nodes for a plugin', async () => {
    const { trackUiNode, clearPluginUi } = await import('@scripts/plugins/registration');
  ...
  it('does nothing for unknown plugin id', async () => {
    const { clearPluginUi } = await import('@scripts/plugins/registration');
...
describe('pluginsMenuList / pluginActionsHost', () => {
  ...
  it('returns the plugins menu list element', async () => {
    const { pluginsMenuList } = await import('@scripts/plugins/registration');
    expect(pluginsMenuList()).toBe(document.getElementById('plugins-menu-list'));
  });

  it('returns the plugin actions host element', async () => {
    const { pluginActionsHost } = await import('@scripts/plugins/registration');
  ...
  it('returns null when elements are missing', async () => {
    document.body.innerHTML = '';
    const { pluginsMenuList, pluginActionsHost } = await import('@scripts/plugins/registration');
...
describe('ensurePluginsMenuPlaceholder / removePluginsMenuPlaceholder', () => {
  ...
  it('adds a disabled placeholder when menu list exists and has no items', async () => {
    const { ensurePluginsMenuPlaceholder } = await import('@scripts/plugins/registration');
  ...
  it('removes the placeholder', async () => {
    const { ensurePluginsMenuPlaceholder, removePluginsMenuPlaceholder } = await import('@scripts/plugins/registration');
    ensurePluginsMenuPlaceholder();
...
describe('registerTheme / registerThemeSummary', () => {
  ...
  it('registers a theme summary accessible via runtime', async () => {
    const { registerThemeSummary } = await import('@scripts/plugins/registration');
...
describe('installGlobalApi wrappers', () => {
  ...
  it('calls addMenuItem, addTitlebarButton, addSettingsSection, addMenubarMenu, invoke, listen, notify through plugin module', async () => {
    const { installGlobalApi, currentPluginIdForRegistration } = await import('@scripts/plugins/registration');
...
describe('addMenuItem', () => {
  ...
  it('adds a menu item button to the plugins menu list', async () => {
    const { addMenuItem } = await import('@scripts/plugins/registration');
  ...
  it('removes placeholder when adding first item', async () => {
    const { addMenuItem, ensurePluginsMenuPlaceholder } = await import('@scripts/plugins/registration');
    ensurePluginsMenuPlaceholder();
    expect(document.querySelector('[data-openvcs-plugin-placeholder="true"]')).not.toBeNull();
...
describe('addTitlebarButton', () => {
  ...
  it('adds a button to the titlebar actions host', async () => {
    const { addTitlebarButton } = await import('@scripts/plugins/registration');
...
describe('applyMenubarMenu', () => {
  ...
  it('inserts a menubar menu into the menubar', async () => {
    const { applyMenubarMenu } = await import('@scripts/plugins/registration');
    applyMenubarMenu('p1', {
      id: 'tools',
...
describe('currentPluginIdForRegistration', () => {
  ...
  it('returns the explicit id when provided', async () => {
    const { currentPluginIdForRegistration } = await import('@scripts/plugins/registration');
...
describe('installGlobalApi full coverage', () => {
  ...
  it('exposes registerTheme, registerThemeSummary, registerAction via global API', async () => {
    const { installGlobalApi, _setApplyPluginSectionsFallback } = await import('@scripts/plugins/registration');
    const { applyPluginSettingsSections } = await import('@scripts/plugins/runtime');
    _setApplyPluginSectionsFallback(applyPluginSettingsSections);
    installGlobalApi();
  ...
  it('executes invoke, listen, and notify through global API', async () => {
    ...
    const { installGlobalApi } = await import('@scripts/plugins/registration');
    installGlobalApi();
...
describe('resetPluginRuntime', () => {
  ...
  it('clears all registrations, scripts, and injected UI', async () => {
    const { installGlobalApi, injectPluginModule, trackUiNode, resetPluginRuntime, registerAction, registerPlugin } = await import('@scripts/plugins/registration');
    installGlobalApi();
