...
describe('wireDeleteBranchConfirm', () => {
  it('sets __wired and skips on second call', async () => {
    const { wireDeleteBranchConfirm } = await import('./deleteBranchConfirm');
...
describe('confirmDeleteBranch', () => {
  it('resolves true via confirm button click', async () => {
    ...
    const { confirmDeleteBranch } = await import('./deleteBranchConfirm');
    const hydrate = (await import('../ui/modals')).hydrate;
    const openModal = (await import('../ui/modals')).openModal;
